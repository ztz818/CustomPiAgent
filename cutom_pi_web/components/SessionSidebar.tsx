...
function PiAgentTitle() {
  ...
  const target = showVersion ? `${process.env.NEXT_PUBLIC_APP_VERSION ?? "0.0.0"}p${process.env.NEXT_PUBLIC_PI_VERSION ?? "0.0.0"}` : "Nova Agent";
  ...
  return (
    <button
      ...
      style={{
        ...
        fontWeight: 700, fontSize: 14, letterSpacing: "0",
...
export function SessionSidebar({ selectedSessionId, onSelectSession, onNewSession, initialSessionId, onInitialRestoreDone, refreshKey, onSessionDeleted, selectedCwd: selectedCwdProp, onCwdChange, onOpenFile, explorerRefreshKey, onAtMention }: Props) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", overflow: "hidden", background: "var(--surface-container)" }}>
      {/* Header */}
      <div
        style={{
      ...
      >
        ...
        {/* CWD picker */}
        <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--text-dim)", marginBottom: 5 }}>
          Workspace
        </div>
        <div ref={dropdownRef} style={{ position: "relative" }}>
          <button
            ...
            style={{
              ...
              alignItems: "center",
              padding: "6px 10px",
              background: selectedCwd ? "var(--surface)" : "var(--bg-selected)",
              border: selectedCwd ? "1px solid var(--outline-variant)" : "1px solid var(--accent)",
              borderRadius: 10,
              cursor: "pointer",
              fontSize: 12,
              color: "var(--text)",
      ...
      {(selectedCwdProp || selectedCwd) && (
        ...
        >
          <div style={{ display: "flex", alignItems: "center", flexShrink: 0, padding: "4px 6px 2px" }}>
            <button
    ...
    <div
      ...
      style={{
        ...
        background: confirmDelete
          ? "rgba(239,68,68,0.06)"
          : isSelected ? "var(--bg-selected)" : hovered ? "var(--surface-container-high)" : "transparent",
