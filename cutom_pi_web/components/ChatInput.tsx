    ...
    >
      ...
      <div style={{ maxWidth: 820, margin: "0 auto" }}>
        ...
        >
          ...
          {isStreaming ? (
            <div style={{ display: "flex", alignItems: "center", gap: 0, flexShrink: 0, alignSelf: "flex-end", border: "1px solid var(--outline-variant)", borderRadius: 10, overflow: "hidden", background: "var(--surface-container)" }}>
              {onSteer && (
                <button
                  ...
                  style={{
                    ...
                    padding: "7px 12px",
                    background: (value.trim() || attachedImages.length) ? "color-mix(in srgb, var(--warning) 14%, transparent)" : "none",
                    border: "none",
                    borderRight: onFollowUp ? "1px solid var(--outline-variant)" : "none",
                    borderRadius: 0,
                    color: (value.trim() || attachedImages.length) ? "var(--text)" : "var(--text-dim)",
              ...
              {onFollowUp && (
                <button
                  ...
                  style={{
                    display: "flex", alignItems: "center", gap: 5,
                    padding: "7px 12px",
                    background: (value.trim() || attachedImages.length) ? "var(--bg-selected)" : "none",
                    border: "none",
                    borderRadius: 0,
                ...
                <div ref={dropdownRef} style={{ position: "relative" }}>
                  <button
                    ...
                    style={{
                      ...
                      background: modelDropdownOpen ? "var(--bg-selected)" : "var(--surface-container)",
                      borderColor: modelDropdownOpen ? "var(--accent)" : "var(--outline-variant)",
                  ...
                  {modelDropdownOpen && modelDropdownRect && (() => {
                    ...
                    <div ref={modelDropdownPanelRef} style={{
                      ...
                      zIndex: 500, background: "var(--surface)", border: "1px solid var(--outline-variant)",
            ...
            {!isStreaming && onThinkingLevelChange && (
              <div ref={thinkingDropdownRef} style={{ position: "relative" }}>
                <button
                  ...
                  style={{
                    display: "flex", alignItems: "center", gap: 5,
                    background: thinkingDropdownOpen ? "var(--bg-selected)" : "var(--surface-container)",
                    borderColor: thinkingDropdownOpen ? "var(--accent)" : "var(--outline-variant)",
                    color: "var(--text-muted)",
                    cursor: isStreaming ? "not-allowed" : "pointer",
                    opacity: isStreaming ? 0.5 : 1,
                  }}
            ...
            {!isStreaming && onToolPresetChange && (
              <div ref={toolDropdownRef} style={{ position: "relative" }}>
                <button
                  ...
                  style={{
                    display: "flex", alignItems: "center", gap: 5,
                    background: toolDropdownOpen ? "var(--bg-selected)" : "var(--surface-container)",
                    borderColor: toolDropdownOpen ? "var(--accent)" : "var(--outline-variant)",
                    color: "var(--text-muted)",
                    cursor: isStreaming ? "not-allowed" : "pointer",
                    opacity: isStreaming ? 0.5 : 1,
                  }}
            ...
            {!isStreaming && onCompact && (
              <div style={{ position: "relative" }}>
                ...
                <button
                  ...
                  style={{
                    display: "flex", alignItems: "center", gap: 5,
                    background: isCompacting ? "color-mix(in srgb, var(--error) 12%, transparent)" : "var(--surface-container)",
                    borderColor: isCompacting ? "color-mix(in srgb, var(--error) 35%, var(--outline))" : "var(--outline-variant)",
            ...
            {isStreaming && (
              <button
                ...
                style={{
                  ...
                  borderColor: "color-mix(in srgb, var(--error) 35%, var(--outline))",
                  color: "var(--error)",
                  cursor: "pointer",
                  fontWeight: 600,
