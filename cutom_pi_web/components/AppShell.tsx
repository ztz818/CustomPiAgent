      ...
      <div style={{ height: "100%", display: "flex", flexDirection: "column", overflow: "hidden", minWidth: 0 }}>
        ...
        <div ref={topBarRef} style={{
          ...
          <IconButton
            ...
            tone={sidebarOpen ? "selected" : "default"}
          >
            {sidebarOpen ? (
          ...
          {showChat && (sessionStats || contextUsage) && (() => {
            ...
            return (
              ...
              >
                {t && t.input > 0 && (
                  <Chip title={`Input tokens: ${t.input.toLocaleString()}`}>
                ...
                {t && t.output > 0 && (
                  <Chip title={`Output tokens: ${t.output.toLocaleString()}`}>
                    <svg width="12" height="12" viewBox="0 0 10 10" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
                ...
                {t && t.cacheRead > 0 && (
                  <Chip title={`Cache read: ${t.cacheRead.toLocaleString()}`}>
                    <svg width="12" height="12" viewBox="0 0 10 10" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
                ...
                {costStr && (
                  <Chip tone="selected" title={`Cost: ${c > 0 ? "$" + c.toFixed(4) : "$0"}`}>
                    {costStr}
                  </Chip>
                )}
                {ctxStr && (
                  <Chip tone={contextUsage?.percent !== null && contextUsage?.percent !== undefined && contextUsage.percent > 90 ? "danger" : contextUsage?.percent !== null && contextUsage?.percent !== undefined && contextUsage.percent > 70 ? "warning" : "default"} title={`Context usage: ${ctxStr}`}>
                    <svg width="12" height="12" viewBox="0 0 10 10" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
